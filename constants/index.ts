...
export const reviews = [
  {
    ...
    review:
      "Iliass is an incredibly talented web develioper. His attention to detail and creative flair are unmatched. He took my website from ordinary to extraordinary, capturing the essence of my brand perfectly. Working with Iliass was a breeze, as he listened to my needs and provided expert guidance throughout the design process. I highly recommend Iliass for anyone looking to elevate their online presence.",
    stars: 5,
    socialLinks: [
      {
        id: 1,
...
export const contactDetails = [
  ...
  },
  {
    id: 2,
    icon: Mail,
    text: "Iliass-Benmessaoud@hotmail.com",
  },
  {
    id: 3,
    icon: MapPin,
